    ...
    return Scaffold(
                ...
                child: Padding(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        Center(
                          child: Text('Nuevas Amenidades', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: blue)),
                        ),
                        SizedBox(height: 20),
                        Center(
                        ...
                        Text(
                          ...
                          style: TextStyle(fontSize: 14, color: purple, height: 1.5),
                        ),
                      ],
                    ),
                  ),
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(CupertinoIcons.group), label: 'Group'),
