...
class ParkingAdminScreen extends StatefulWidget { // <-- was StatelessWidget
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(isResident ? 'Residente' : 'Visitante', style: const TextStyle(fontSize: 12, color: Colors.grey)),
      ...
      body: FutureBuilder<List<Parking>>(
        ...
        builder: (context, snapshot) {
          ...
          String _categoryTitle(String raw) {
            ...
            if (v.contains('reg') || v.contains('res')) return 'Parqueaderos de Residentes';
          ...
          final titles = [
            ...
            ...groups.keys.where((k) => !desiredOrder.contains(k)).toList()..sort(),
          ];
                ...
                Row(
                  children: [
                    Expanded(
                      child: SizedBox(
                        height: 40,
                        child: TextField( // <-- remove const, wire controller
                    ...
                    ElevatedButton.icon(
                      ...
                      label: Text(
                        _typeFilter == null
                            ? 'Filtros'
                            : (_typeFilter == 'resident' ? 'Residentes' : 'Visitantes'),
