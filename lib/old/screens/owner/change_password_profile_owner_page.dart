...
class ChangePasswordProfileOwnerPage extends StatefulWidget {
  ...
  @override
  State<ChangePasswordProfileOwnerPage> createState() =>
      _ChangePasswordProfileOwnerPageState();
}

class _ChangePasswordProfileOwnerPageState
    extends State<ChangePasswordProfileOwnerPage> {
  int _tab = 0;
